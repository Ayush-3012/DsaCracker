...
const LogIn = () => {
  ...
  const handleLogIn = (e) => {
    e.preventDefault();
    axios
      .get(`http://localhost:5000/registeredUsers/getUser?email=${email}`)
      .then((res) => {
        if (res.data) {
  ...
  return (
    <>
      <div className="flex flex-col gap-2 items-center py-24 w-full bg-slate-700 mx-4 rounded-xl justify-center max-md:mx-1">
